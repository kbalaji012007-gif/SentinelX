...
const navigation = [
  ...
  { name: "Threats", href: "/threats", icon: ExclamationTriangleIcon, badge: "7" },
  { name: "Incidents", href: "/incidents", icon: ShieldExclamationIcon, badge: "4" },
  { name: "Assets", href: "/assets", icon: ServerIcon },
  { name: "Logs", href: "/logs", icon: DocumentTextIcon },
  { name: "Threat Intelligence", href: "/intelligence", icon: CpuChipIcon },
  { name: "Vulnerabilities", href: "/vulnerabilities", icon: BugAntIcon, badge: "14" },
          ...
          >
            ...
            {item.badge && (
              <span className={`px-2 py-0.5 text-[10px] font-bold rounded-full ${
                item.name === "Threats" ? "bg-[var(--color-critical)]/20 text-[var(--color-critical)] border border-[var(--color-critical)]/30" :
                item.name === "Incidents" ? "bg-[var(--color-high)]/20 text-[var(--color-high)] border border-[var(--color-high)]/30" :
